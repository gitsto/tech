					...
					ConfigurationPorpriete conf =
		                ...
		                if (conf != null){
		                     if (conf.group.equals("Railroad")){
		                    	 caseEnCourt = new CaseGare (conf.name, conf.price);
		                    }
		                    else if (conf.group.equals("Utility")){
		                    	caseEnCourt= new CaseService(conf.name, conf.price);
		                    }
		                    else {
		                    	caseEnCourt = new CaseLot(conf.name, conf.price, conf.position);
		                    }
		                }
		                else {
