...
public class PhiloActif extends Philosophe {
    ...
    public PhiloActif(String nm, int nu, long dR, long dM, ExecutorService srv, IGestBaguettes s, int b1, int b2) {
    	super(nm, nu, dR, dM);
    	gui = new PhiloGUI1();
    	gui.initialiser(nu);
    ...
    public PhiloActif(int nu, ExecutorService srv, IGestBaguettes s, int b1, int b2) { this("philo" + nu, nu, 1000, 1000, srv, s, b1, b2); }
